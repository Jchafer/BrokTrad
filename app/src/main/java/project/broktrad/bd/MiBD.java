...
public class MiBD extends SQLiteOpenHelper implements Serializable {
    ...
    private void insercionDatos(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO favoritos (gasol_long, gasol_lat, usuario) VALUES ('-1,849833', '39,000861', 'prueba@prueba.com');");
        db.execSQL("INSERT INTO favoritos (gasol_long, gasol_lat, usuario) VALUES ('-1,849835', '39,000862', 'ppprueba@prueba.com');");
    }
